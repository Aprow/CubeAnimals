...
#battle
max_stage = 12#if you survived after turn 12, you win.
life = 30#if your life is below 0, you lose.
...
characterdata = {
    ...
    'marmot': {'lv':1,'hp':8,'atk':1,'spd':5,'range':3,'tar':'rand','effects':{'start':['marmot0']}},
    ...
    #lv3(14)
    'duck':   {'lv':3,'hp':15,'atk':4,'spd':7,'range':1,'tar':'rand','effects':{'attack':['duck0']}},
...
#get position:
def adjust_x(x):#adjust from original 2200*1400 screen
    return int(x)
